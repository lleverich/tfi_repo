...
advocate = read.csv("2024 Mason Roberts/Outputs/GA Inputs_Costs.csv")
```
...
df1 <- advocate %>%
  left_join(price_long, by = c("Source", "Year")) %>%
...
# Save csv
write.csv(df3, file = "C:/Users/LeannaLeverich/The Fertilizer Institute/TFI - Programs/Research/4R/4R Calculator/4R Advocate Case Studies/2024 Bryant Lowe/Outputs/DE Inputs_Costs.csv", row.names = FALSE)
