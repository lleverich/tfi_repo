...
write.csv(nue, file = "C:/Users/LeannaLeverich/The Fertilizer Institute/TFI - Programs/Research/4R/4R Calculator/Leanna's Calculator/NUE Summary.csv", row.names = FALSE)
```
...
write.csv(costPerAc, file = "C:/Users/LeannaLeverich/The Fertilizer Institute/TFI - Programs/Research/4R/4R Calculator/Leanna's Calculator/Cost Summary.csv", row.names = FALSE)
```
...
write.csv(farm3, file = "C:/Users/LeannaLeverich/The Fertilizer Institute/TFI - Programs/Research/4R/4R Calculator/Leanna's Calculator/N2O Summary.csv", row.names = FALSE)
